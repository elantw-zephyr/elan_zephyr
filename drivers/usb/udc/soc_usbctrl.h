...
#ifndef ZEPHYR_DRIVERS_USB_UDC_EM32_H
#define ZEPHYR_DRIVERS_USB_UDC_EM32_H
...
enum usb_irqn_type {
    USB_EM32_SETUP_IRQ_NUM = 4,
    USB_EM32_SUSPEND_IRQ_NUM = 5,
    USB_EM32_RESUME_IRQ_NUM = 6,
    USB_EM32_RESET_IRQ_NUM = 7,
    USB_EM32_EPX_IN_EPX_EMPTY_IRQ_NUM = 8,
    USB_EM32_EPX_OUT_IRQ_NUM = 9,
};
#endif
